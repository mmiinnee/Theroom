...
interface BookingFragmentRepository {
    suspend fun selectRoomByBedType(buildingNumber: String, bedType: String): MutableList<RoomEntity>

    suspend fun selectRoomByPeopleSize(buildingNumber: String, peopleSize: String): MutableList<RoomEntity>
